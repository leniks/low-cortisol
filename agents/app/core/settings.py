...
class AgentSettings:
    ...
    def from_env(cls) -> "AgentSettings":
        ...
        classifier_model = os.getenv("YANDEX_CLASSIFIER_MODEL", chat_model)
        ...
        return cls(
            ...
            yandex_classifier_model=classifier_model,
            yandex_clarifier_model=os.getenv("YANDEX_CLARIFIER_MODEL", classifier_model),
            yandex_query_enricher_model=os.getenv("YANDEX_QUERY_ENRICHER_MODEL", classifier_model),
            yandex_reranker_model=os.getenv("YANDEX_RERANKER_MODEL", classifier_model),
